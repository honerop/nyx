...
{
  # Generated by nyx-install — real disk layout for this machine.
...
echo "  /etc/nixos/hosts/template/disko.local.nix"
echo
echo "To update later:"
echo "  cd /etc/nixos && git pull && sudo nixos-rebuild switch --flake /etc/nixos#nyx"
echo "Then: reboot"
